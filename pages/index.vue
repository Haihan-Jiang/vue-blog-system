  ...
  <div>
    ...
    <div class="py-4 text-center md:text-left search-tip" :class="{'show': searchText}">
      <h1 class="text-lg font-bold flex flex-col md:flex-row justify-center md:justify-start items-center space-x-1
        ...
        <span class="text-lg font-thin"><span class="font-bold">"{{ searchText }}"</span> {{ $t('search.search_result_tip') }}</span>
      </h1>
    </div>
    <div class="grid gap-4 grid-cols-1 -mt-2">
      <PrimaryInput id="search-input" key="search-input" placeholder="" class="search-input" v-model="searchText"/>
    </div>
...
<!-- <font-awesome-icon icon="fa-solid fa-sensor" /> -->
